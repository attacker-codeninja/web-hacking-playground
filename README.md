...
Web Hacking Playground is a controlled environment for conducting web hacking tests. It consists of a series of vulnerabilities found in real cases, both in pentests and in Bug Bounty programs. The objective is that users can practice with them, and learn to detect and exploit them.
